...
class Bawabatech extends StatefulWidget {
  @override
  _BawabatechState createState() => _BawabatechState();
}

class _BawabatechState extends State<Bawabatech> {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.statusCode < 400) {
        setState(() {
          ...
          link = json.decode(response.body)['data']['main_pages'][1]['link'];
